...
- [SYLLABUS.md](./SYLLABUS.md) — Official course syllabus with learning outcomes
- [Assignments](./assignments/) — All course assignments
- [Case Studies](./case-studies/) — Quantum Musico, social media ethics, and more
- [Resources](./resources/) — BBS frameworks, glossaries, and dataset packages
